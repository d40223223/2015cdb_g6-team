...
class Hello(object):
    ...
    def index(self):
        ...
        <body>
        <a href="drawspur">個人齒輪製作</a><br />
        <a href="drawspur2">協同齒輪製作</a><br />
        </body>
        </html>
        '''
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def drawspur(self, N=15, M=24, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def drawspur2(self, N=15, M=24, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def drawspuraction1(self, N=20, M=5, P=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
